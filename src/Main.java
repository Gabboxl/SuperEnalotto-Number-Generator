	...
	public enum Color {
		...
		public static void main(String[] args) {
			...
			System.out.println("How many numbers do you want? (enter a number or write 'exit' to close the program): ");
			 ...
			 if(n.equals("exit")) {
				 System.out.print("\n" + Color.BLACK_BOLD + Color.CYAN_BACKGROUND);
				 System.out.print("Thx for using SuperEnalotto Number Generator - ");
				 System.out.println(Color.RESET);
				 reader.close();
				 System.exit(0);
			}
			...
			System.out.println("\n");
				...
				System.out.print("\n" + Color.BLACK_BOLD + Color.RED_BACKGROUND);
				System.out.print("Insert a number thx");
				System.out.println(Color.RESET);
			}
